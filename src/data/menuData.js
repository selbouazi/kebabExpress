...
export const menuCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'p8', name: 'Mixto kebab + picante', desc: '', price: 7.50, allergens: ['gluten', 'lacteos'] },
  ...
  },
  {
    name: 'Entrantes',
    items: [
      { id: 'k12', name: 'Falafel', desc: 'Con pan turco', price: 5.00, allergens: ['gluten'] },
      { id: 'k13', name: 'Falafel', desc: 'Con pan durum', price: 5.50, allergens: ['gluten'] },
      { id: 'k14', name: 'Falafel', desc: 'En plato', price: 5.50 },
      ...
      { id: 'c12', name: 'Seekh kebab (4 uds)', desc: '', price: 6.00, isBestseller: true },
