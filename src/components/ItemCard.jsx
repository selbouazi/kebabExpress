      ...
      <TiltCard tiltDegree={10}>
        <div className="glass-card rounded overflow-hidden">
          <div className="aspect-[4/3] bg-gradient-to-br from-green-dark to-green-brand/80 flex items-center justify-center relative overflow-hidden">
            <motion.div
              className="absolute inset-0 bg-gradient-to-tl from-gold/5 to-transparent"
              initial={{ opacity: 0 }}
            ...
            >
              <UtensilsCrossed size={48} className="text-gold/15 group-hover:text-gold/25 transition-colors duration-500" />
            </motion.div>
            <div className="absolute inset-0 bg-gradient-to-t from-green-card/40 to-transparent" />
            <span
              className="absolute top-3 right-3 bg-gold text-green-brand font-bold text-base px-2.5 py-1 rounded shadow-lg z-10"
            ...
            {item.isBestseller && (
              <span
                className="absolute top-3 left-3 bg-gradient-to-r from-red-cola to-red-500 text-white font-bold text-xs px-2.5 py-1 rounded shadow-lg flex items-center gap-1 z-10 animate-pulse"
                style={{ transformStyle: 'preserve-3d', transform: 'translateZ(20px)' }}
              >
